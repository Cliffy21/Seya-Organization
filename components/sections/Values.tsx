...
const values: Value[] = [
  {
    name: "Diversity",
    description: "We work with all-inclusive backgrounds.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  {
    name: "Integrity",
    description: "All members shall conduct themselves with at most honesty",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  {
    name: "Transparency",
    description: "All matters will always be wide open.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  {
    name: "Teamwork",
    description: "All members shall be bonded by all SEYA values.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  return (
    <section ref={ref} className="bg-muted py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:grid-rows-2">
          {values.map((value, index) => (
            <motion.div
              ...
              className="flex flex-col rounded-xl bg-background p-8 shadow-sm ring-1 ring-border transition-all hover:shadow-md"
            >
