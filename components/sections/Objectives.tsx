...
const objectives: Objective[] = [
  {
    title: "Empower Youth",
    description:
      "Empower youth aged 9-24 years for a healthy lifestyle through access to health information and services.",
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
  ...
  {
    title: "Support Youth Businesses",
    description:
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          {objectives.map((objective, index) => (
            <motion.div
              ...
              className="flex flex-col justify-between rounded-xl bg-background p-8 shadow-sm ring-1 ring-border transition-all hover:shadow-md"
            >
              <div>
